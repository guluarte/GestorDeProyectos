...
namespace ProyectoTerminal.Controllers
{
    public class RequerimientoController : Controller
    {
        ...
        {
            var requerimientos = db.Requerimientoes.Where(n => n.ProyectoId == pId);
        ...
        public ActionResult Create([Bind(Include="Id,Nombre,Descripcion,ProyectoId,Tipo")] Requerimiento requerimiento)
        {
            if (ModelState.IsValid)
            {
                ...
                db.SaveChanges();
                return RedirectToAction("Index", new { pId = requerimiento.ProyectoId });
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="Id,Nombre,Descripcion,ProyectoId,Tipo")] Requerimiento requerimiento)
        {
            if (ModelState.IsValid)
            {
